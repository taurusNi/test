...
# wget --no-check-certificate https://dl.openwrt.ai/packages-24.10/x86_64/kiddin9/geoview_0.1.2-r3_x86_64.ipk
# wget --no-check-certificate https://dl.openwrt.ai/packages-24.10/x86_64/kiddin9/tcping_0.3-r2_x86_64.ipk
...
make image PACKAGES="$PACKAGES" ROOTFS_PARTSIZE=1024 CONFIG_VMDK_IMAGES=y CONFIG_GRUB_IMAGES=y